...
function Contact() {
  ...
  const style = {
    input:
      "mt-2 text-white rounded-md block w-full p-2.5 bg-stone-800 focus:outline-none focus:border focus:border-green-400 focus:mt-[6px]",
    button:
      "max-h-fit mt-2 mx-auto bg-transparent hover:bg-green-400 text-md lg:text-xl text-green-400 font-frankyFont hover:text-black font-medium py-2 px-8 border border-green-400 hover:border-transparent rounded transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110",
  };
