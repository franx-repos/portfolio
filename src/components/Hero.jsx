    ...
    <>
      <div className="h-screen" id="vanta">
        ...
        >
          ...
          <a
            className="bg-transparent hover:bg-green-400 text-xl lg:text-2xl text-green-400 font-frankyFont hover:text-black font-medium py-2 px-8 border border-green-400 hover:border-transparent rounded mt-5 transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110"
            href="#projects"
          >
            View my work
          </a>
