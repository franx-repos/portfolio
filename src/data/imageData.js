...
export const images = {
  skills: [
    { title: "javascript", url: jsIcon },
    { title: "html", url: htmlIcon },
  ...
  "sowo-gv-onboarder": [
    ...
    { title: "mobile", url: sowoScreenshot_4 },
  ],
  "tax-max": [
    { title: "start page", url: homePage_1 },
    { title: "partner and task slider", url: homePage_2 },
    { title: "register page", url: registerPage },
    { title: "profile page", url: profilePage },
  ],
};
